...
const { cocktail_get, cocktail_post, cocktail_get_cocktail, cocktail_put, cocktail_delete, cocktail_upload_image, popular_cocktails_get } = require('../controllers/cocktailController');
